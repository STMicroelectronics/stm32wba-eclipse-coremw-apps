...
This application provides an example of Eclipse FileX stack usage on NUCLEO-WBA65RI  board, running in standalone mode (without FreeRTOS). It demonstrates how to create a Fat File system on the internal SRAM memory using Eclipse FileX API.
